...
import { authorsEditorsAndAdmins, authorsOwnPostsOrEditors, editorsAndAdmins, editorsAndAdminsField } from '@/access/roles'
...
export const Posts: CollectionConfig<'posts'> = {
  slug: 'posts',
  access: {
    create: authorsEditorsAndAdmins,
    delete: editorsAndAdmins,
    read: authenticatedOrPublished,
    update: authorsOwnPostsOrEditors,
  },
  ...
  hooks: {
    afterChange: [
      revalidatePost,
      createCollectionAuditAfterChange('posts'),
      createCollectionWebhookAfterChange('posts'),
    ],
    afterRead: [populateAuthors],
    beforeChange: [enforceEditorialWorkflow],
    afterDelete: [
      revalidateDelete,
      createCollectionAuditAfterDelete('posts'),
      createCollectionWebhookAfterDelete('posts'),
    ],
  },
  versions: {
    drafts: {
